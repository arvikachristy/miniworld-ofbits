...
Our agent learns under a model-free environment which means limited infromation about environment(only one reward and image of section where cursor can move) can be viewed .By taking advantage of source code of openai environment provided by andrej later,we can learning more information about the environment such as telling which is best policy in training process and speed up training process by using reward manipulation.

Due to the complexity of combination of CNN and reinforcement learning,a machine even a cluster of machines with more GPUs  is always sought. 
